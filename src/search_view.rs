...
// use crate::launcher::children::RenderableChildImpl;
// use gpui::{
//     App, Bounds, ClipboardItem, Context, CursorStyle, ElementId, ElementInputHandler, Entity,
//     EntityInputHandler, FocusHandle, Focusable, GlobalElementId,
//     LayoutId, ListState, MouseButton, MouseDownEvent, MouseMoveEvent, MouseUpEvent, PaintQuad,
//     Pixels, Point, ShapedLine, SharedString, Style, Subscription, TextRun,
//     UTF16Selection, UnderlineStyle, Window, actions, div, fill, hsla, list, point, prelude::*,
...
//     pub data: Entity<Vec<RenderableChild>>,
//     pub focus_handle: FocusHandle,
...
//                                     if let Some(ks) = state.data.read(cx).get(idx) {
...
//         result
//     }
//     fn render_result_item(&self, what: &impl RenderableChildImpl, idx: usize) -> impl IntoElement {
...
//                 }
//             })
//             .child(what.render(&self, is_selected))
//     }
// }
